...
def _enqueue_reminder(a, ds, *, delivery_id: str):
    ...
    return _outbox_row(ds, delivery_id)
...
def _race_scenario(*, action: str, delivery_id: str):
    ...
    row = _enqueue_reminder(a, ds, delivery_id=delivery_id)
...
def _check_internal_send_race(r):
    ok = (
        r["sent"] == []
        and r["rows"][0][1] == "dropped_stale"
        and r["rows"][0][2] == r["expected_error"]
...
def test_ack_before_urlopen():
    return _check_internal_send_race(
